...
export default function App() {
  ...
  return (
    <div className="min-h-screen noise-bg font-sans bg-brand-dark text-brand-light selection:bg-brand-primary selection:text-brand-dark">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#120a06]/35 backdrop-blur-2xl backdrop-saturate-150 border-b border-white/10 transition-all duration-300">
