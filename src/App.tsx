    ...
    <div className="min-h-screen noise-bg font-sans bg-brand-dark text-brand-light selection:bg-brand-primary selection:text-brand-dark">
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col justify-center min-h-[90vh]">
        ...
        <motion.div className="absolute inset-0 z-0 origin-center" style={{ y: bgY, scale: bgScale }}>
          ...
          <motion.div 
            style={{ y: smokeY, opacity: useTransform(scrollY, [0, 500], [0.3, 0.6]) }}
          ...
          <motion.div 
            style={{ y: useTransform(scrollY, [0, 1000], ['0%', '-15%']), opacity: useTransform(scrollY, [0, 500], [0.15, 0.05]) }}
...
// Temporary internal icons for services since relying only on lucide subset
...
function BoxSelect(props: any) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M5 3a2 2 0 0 0-2 2"/><path d="M19 3a2 2 0 0 1 2 2"/><path d="M21 19a2 2 0 0 1-2 2"/><path d="M5 21a2 2 0 0 1-2-2"/><path d="M9 3h1"/><path d="M9 21h1"/><path d="M14 3h1"/><path d="M14 21h1"/><path d="M3 9v1"/><path d="M21 9v1"/><path d="M3 14v1"/><path d="M21 14v1"/></svg>;
}
function Nut(props: any) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 4V2"/><path d="M5 10l-2-1"/><path d="M19 10l2-1"/><path d="M5 14l-2 1"/><path d="M19 14l2 1"/><path d="M12 20v2"/><path d="m9 7 6 10"/><path d="m15 7-6 10"/></svg>;
}
